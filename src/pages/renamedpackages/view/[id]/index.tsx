...
import { getRenamedpackageById } from 'apiSdk/renamedpackages';
...
function RenamedpackageViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Renamedpackage Detail View
          </Text>
          {hasAccess('renamedpackage', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/renamedpackages/edit/${data?.id}`} passHref legacyBehavior>
              <Button
